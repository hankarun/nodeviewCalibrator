// Desktop renderer for Node View Calibrator - Three.js 3D version
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function updateNearPlaneVisualization() {
    if (selectedDisplayIndex >= 0 && lockDisplayPositionInput.checked) {
  ...
  function handleSaveConfig() {
    saveConfig(displays).catch(error => console.error('Error saving file:', error));
  }

  function handleSaveConfigAs() {
    saveConfigAs(displays).catch(error => console.error('Error saving file:', error));
  }
